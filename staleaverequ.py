...
q = """select * from staffleave where status='PENDING'"""
cur.execute(q)
a = cur.fetchall()
print("""
<!DOCTYPE html>
...
<head>
  ...
  <title>New leave Requests of Staff</title>
...
<body style="background-image:url('images/table.jpg');">
 <div class="header">
  ...
  <table class=" container table table-bordered margin-toppest caption-top">
    <caption class="text-center display-5 text-primary mb-1">Staff Details</caption>
    <br><br>
    <thead>
      <tr>
        <th>Leave ID</th>
...
for i in a:
    ...
    <tbody>
      <tr>
        ...
        <td>%s</td>
        <td>
          <a href="approvestaleave.py?id=%s" class="btn btn-success">Approve</a>
          <a href="rejectstaleave.py?id=%s" class="btn btn-danger">Reject</a>
        </td>
      </tr>
